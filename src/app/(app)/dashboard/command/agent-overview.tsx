...
const AGENTS: AgentOverviewDef[] = [
  ...
  },
  {
    ...
    role: "Business Development & Sales Manager — HV/Bus/Coach",
    division: "Growth & Intelligence",
    icon: TrendingUp,
    color: "text-emerald-400",
    borderColor: "border-emerald-500/30",
    bgGlow: "from-emerald-500/10 via-emerald-500/5 to-transparent",
    description: "Heavy vehicle, bus/coach and commercial fleet sales. Direct report: Emily Mercer. Pipeline tracking, outreach, BANT scoring.",
    email: "development@asi-australia.com.au",
  ...
  },
  {
    ...
    role: "Passenger Vehicle & Trade Sales Specialist",
    division: "Growth & Intelligence",
    icon: TrendingUp,
    color: "text-teal-400",
    borderColor: "border-teal-500/30",
    bgGlow: "from-teal-500/10 via-teal-500/5 to-transparent",
    description: "Passenger vehicle and trade sales specialist. Reports to David Sentinel. Owns light vehicle market engagement and trade channel sales support.",
    email: "development@asi-australia.com.au",
